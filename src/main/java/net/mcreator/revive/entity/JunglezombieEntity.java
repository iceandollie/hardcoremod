...
public class JunglezombieEntity extends Monster {
	public JunglezombieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ReviveModEntities.JUNGLEZOMBIE.get(), world);
	}

	public JunglezombieEntity(EntityType<JunglezombieEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
