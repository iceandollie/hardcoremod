...
public class InfermooEntity extends Monster {
	...
	public static void init() {
		SpawnPlacements.register(ReviveModEntities.INFERMOO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
