...
package net.mcreator.revive.entity;
...
import net.mcreator.revive.procedures.InfermooRightClickedOnEntityProcedure;
import net.mcreator.revive.init.ReviveModEntities;

import java.util.List;

public class InfermooEntity extends Animal {
	public InfermooEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ReviveModEntities.INFERMOO.get(), world);
	}

	public InfermooEntity(EntityType<InfermooEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		InfermooEntity retval = ReviveModEntities.INFERMOO.get().create(serverWorld);
