...
public class BanditEntity extends Monster {
	public BanditEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ReviveModEntities.BANDIT.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(ReviveModEntities.BANDIT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
