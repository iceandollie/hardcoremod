...
public class Modelinfermoo<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("revive", "modelinfermoo"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(22, 0).addBox(-5.0F, -5.0F, -4.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
				.addBox(-4.0F, -4.0F, -6.0F, 8.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(22, 0).addBox(4.0F, -5.0F, -4.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 4.0F, -8.0F));
		PartDefinition mushroom4 = head.addOrReplaceChild("mushroom4",
				CubeListBuilder.create().texOffs(0, 32).addBox(-8.0F, -16.0F, 0.0F, 16.0F, 16.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 16).addBox(0.0F, -16.0F, -8.0F, 0.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition mushroom2 = mushrooms.addOrReplaceChild("mushroom2", CubeListBuilder.create(), PartPose.offsetAndRotation(-2.025F, 0.0F, 2.8F, 0.0F, 0.6807F, 0.0F));
		PartDefinition mushroom3 = mushrooms.addOrReplaceChild("mushroom3", CubeListBuilder.create(), PartPose.offsetAndRotation(3.2F, 0.0F, 11.0F, 0.0F, -0.0524F, 0.0F));
